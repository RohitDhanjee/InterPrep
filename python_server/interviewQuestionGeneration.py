...
from key import OpenApikey  # Use relative import if 'key.py' is in the same folder, or adjust the path as needed
...
def interviewQuestionGeneration(extractedText, formData):
    ...
    # New/Correct Call:
    return openaiModel.invoke(formattedTemplateQA)
