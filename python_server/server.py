...
allowed_origins = [
    'http://localhost:63381', # Replace 63381 with the port your Flutter app is currently running on
    'http://127.0.0.1:63381', 
    'http://localhost:55031', # Also list common ports like 5000, 8080, etc. just in case
...
app = Flask(__name__)
# CORS(app)
CORS(app, resources={r"/api/*": {"origins": allowed_origins, "methods": ["GET", "POST"]}})
